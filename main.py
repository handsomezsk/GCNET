...
def main():
    ...
    train_dataset = KITTI2015('../dataset/data_scene_flow', mode='train', transform=train_transform)
    train_loader = DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=1)

    validate_transform = T.Compose([Normalize(mean, std), ToTensor(),Pad(384,1248)])
    validate_dataset = KITTI2015('../dataset/data_scene_flow', mode='validate', transform=validate_transform)
